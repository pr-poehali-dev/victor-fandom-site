              ...
              <CardContent className="p-8 md:p-12">
                ...
                <div className="space-y-6 text-lg">
                  <p className="leading-relaxed">
                    <strong className="text-primary">Безденежный Виктор Сергеевич</strong>, более известный как создатель телеграмм канала бешки live, 
                    благодеятель, участник СВО, порноактер, музыкант, будущий алкоголик. Также у Виктора есть своя партия. 
                    Виктор является иноагентом и депутатом.
                  </p>
